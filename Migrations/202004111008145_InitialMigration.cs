                ...
                c => new
                    {
                        ...
                        IC = c.String(nullable: false, maxLength: 12),
                ...
                c => new
                    {
                        ...
                        product = c.String(nullable: false, maxLength: 255),
                ...
                c => new
                    {
                        ...
                        rollerID = c.String(nullable: false, maxLength: 15),
                        type = c.String(nullable: false, maxLength: 100),
                        usage = c.String(nullable: false, maxLength: 255),
                        shoreHardness = c.String(nullable: false, maxLength: 100),
                        diameter = c.Double(nullable: false),
                        depthOfGroove = c.String(nullable: false, maxLength: 100),
                        condition = c.String(nullable: false, maxLength: 255),
                        last_usage_date = c.DateTime(),
                        opening_stock_date = c.DateTime(),
                        remark = c.String(maxLength: 255),
                        isRefurbished = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        diameterCore = c.Double(nullable: false),
                        diameterRoller = c.Double(nullable: false),
                        totalMileage = c.Int(nullable: false),
                        openingStockDate = c.DateTime(),
                        lastProductionLine = c.String(),
                        reason = c.String(nullable: false, maxLength: 255),
                        remark = c.String(maxLength: 255),
                        newDiameter = c.Double(nullable: false),
                        sendTo = c.String(nullable: false),
                        newShoreHardness = c.String(nullable: false, maxLength: 255),
                        correctiveAction = c.String(maxLength: 255),
                        status = c.Int(nullable: false),
                        sendForRefurbished = c.Boolean(nullable: false),
                        statusRemark = c.String(),
                        imagePath = c.String(),
                ...
                c => new
                    {
                        ...
                        dateTime = c.DateTime(nullable: false),
                        controller = c.String(nullable: false, maxLength: 255),
